...
export default function UbahPassword({route, navigation}) {
  return (
    <Container>
      ...
      <Content style={{padding: 25}}>
        <Form>
          <Item style={{marginTop: 15}}>
            ...
            />
            <Input style={{fontSize: 16}} placeholder="Password Baru" />
          </Item>
          <Item style={{marginTop: 15}}>
            <Icon
              active
              ...
              style={{color: '#066A19', fontSize: 16}}
            />
            <Input style={{fontSize: 16}} placeholder="Konfirmasi Password" />
          </Item>
        </Form>
        <Button
          style={{
